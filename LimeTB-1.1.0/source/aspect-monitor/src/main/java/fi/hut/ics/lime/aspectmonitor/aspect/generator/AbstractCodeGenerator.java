...
public abstract class AbstractCodeGenerator {
	...
	protected Map<Method, JavaAroundAdvice> advices;
	...
	protected AbstractCodeGenerator(Specification specification) {
		...
		this.advices = new Hashtable<Method, JavaAroundAdvice>();
	}
	...
	public void addToAspect(Aspect aspect) throws AspectException {
		for(Method method : specification.getEnforcedMethods()) {
			...
			advice.setPointcut(((AspectJAspectFactory)aspectFactory).methodToPointcut(method));
