...
public class SpecExecutionSampler {
	...
	public void addToAspect(AspectJAspect aspect) {
		...
		if (spec.getSpecType() == SpecType.CALL)
			updateMethod.addEnd(pathSelectionHeuristicInstance + ".updateCallSpec(this, " + arrayAccess + ");");
		else
			updateMethod.addEnd(pathSelectionHeuristicInstance + ".updateReturnSpec(this, " + arrayAccess + ");");
