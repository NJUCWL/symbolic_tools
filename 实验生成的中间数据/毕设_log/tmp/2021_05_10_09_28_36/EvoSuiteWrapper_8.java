...
public class EvoSuiteWrapper_8 {
    ...
    public EvoSuiteWrapper_8(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.ClassGen V0, org.apache.bcel.classfile.Method V1, int V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:method", V1);
        candidateObjects.put("{ROOT}:pos", V2);
