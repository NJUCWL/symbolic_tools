...
public class EvoSuiteWrapper_11 {
    ...
    public EvoSuiteWrapper_11(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.ClassGen V0, org.apache.bcel.classfile.Method V1, org.apache.bcel.classfile.Method V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:old", V1);
        candidateObjects.put("{ROOT}:new_", V2);
