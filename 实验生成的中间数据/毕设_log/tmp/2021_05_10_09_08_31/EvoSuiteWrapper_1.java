...
public class EvoSuiteWrapper_1 {
    ...
    public double test0(org.apache.bcel.generic.MULTIANEWARRAY V0, org.apache.bcel.util.ByteSequence V1, boolean V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:bytes", V1);
        candidateObjects.put("{ROOT}:wide", V2);
