...
public class EvoSuiteWrapper_6 {
    ...
    public double test0(org.apache.bcel.generic.MULTIANEWARRAY V0, org.apache.bcel.generic.ConstantPoolGen V1) throws Exception {
        ...
        candidateObjects.put("{ROOT}:cpg", V1);
