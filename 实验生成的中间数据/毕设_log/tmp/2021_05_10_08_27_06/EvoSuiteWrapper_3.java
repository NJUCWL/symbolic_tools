...
public class EvoSuiteWrapper_3 {
    ...
    public EvoSuiteWrapper_3(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionList V0, org.apache.bcel.generic.CodeExceptionGen[] V1, org.apache.bcel.generic.InstructionHandle V2, org.apache.bcel.generic.InstructionHandle V3) throws Exception {
        ...
        candidateObjects.put("{ROOT}:exceptions", V1);
        candidateObjects.put("{ROOT}:old_target", V2);
        candidateObjects.put("{ROOT}:new_target", V3);
