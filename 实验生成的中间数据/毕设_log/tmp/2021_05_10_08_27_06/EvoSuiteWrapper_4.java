...
public class EvoSuiteWrapper_4 {
    ...
    public double test0(org.apache.bcel.generic.InstructionHandle[] V0, int[] V1, int V2, int V3) throws Exception {
        ...
        candidateObjects.put("{ROOT}:ihs", V0);
        candidateObjects.put("{ROOT}:pos", V1);
        candidateObjects.put("{ROOT}:count", V2);
