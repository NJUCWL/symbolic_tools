...
public class EvoSuiteWrapper_19 {
    ...
    public double test0(org.apache.bcel.generic.InstructionList V0, org.apache.bcel.generic.InstructionHandle V1, org.apache.bcel.generic.InstructionHandle V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:old_target", V1);
        candidateObjects.put("{ROOT}:new_target", V2);
