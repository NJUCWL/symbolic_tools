...
public class EvoSuiteWrapper_39 {
    ...
    public EvoSuiteWrapper_39(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionList V0, org.apache.bcel.generic.ConstantPoolGen V1, org.apache.bcel.generic.ConstantPoolGen V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:old_cp", V1);
        candidateObjects.put("{ROOT}:new_cp", V2);
