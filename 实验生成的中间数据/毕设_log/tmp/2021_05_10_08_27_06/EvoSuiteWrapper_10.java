...
public class EvoSuiteWrapper_10 {
    ...
    public EvoSuiteWrapper_10(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionList V0, org.apache.bcel.generic.InstructionHandle V1, org.apache.bcel.generic.InstructionHandle V2, org.apache.bcel.generic.InstructionHandle V3) throws Exception {
        ...
        candidateObjects.put("{ROOT}:start", V1);
        candidateObjects.put("{ROOT}:end", V2);
        candidateObjects.put("{ROOT}:target", V3);
