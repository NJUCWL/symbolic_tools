...
public class EvoSuiteWrapper_34 {
    ...
    public EvoSuiteWrapper_34(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionList V0, org.apache.bcel.generic.InstructionListObserver V1) throws Exception {
        ...
        candidateObjects.put("{ROOT}:o", V1);
