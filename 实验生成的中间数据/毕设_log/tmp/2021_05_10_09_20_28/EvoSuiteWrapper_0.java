...
public class EvoSuiteWrapper_0 {
    ...
    public EvoSuiteWrapper_0(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionFactory V0, org.apache.bcel.generic.Type V1, short V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:t", V1);
        candidateObjects.put("{ROOT}:dim", V2);
