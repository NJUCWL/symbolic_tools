...
public class EvoSuiteWrapper_7 {
    ...
    public EvoSuiteWrapper_7(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionFactory V0, org.apache.bcel.generic.Type V1, org.apache.bcel.generic.Type V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:src_type", V1);
        candidateObjects.put("{ROOT}:dest_type", V2);
