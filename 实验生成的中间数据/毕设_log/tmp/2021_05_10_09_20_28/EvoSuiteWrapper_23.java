...
public class EvoSuiteWrapper_23 {
    ...
    public double test0(java.lang.String V0, org.apache.bcel.generic.Type V1) throws Exception {
        ...
        candidateObjects.put("{ROOT}:op", V0);
        candidateObjects.put("{ROOT}:type", V1);
