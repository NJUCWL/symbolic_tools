...
public class EvoSuiteWrapper_6 {
    ...
    public EvoSuiteWrapper_6(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionFactory V0, java.lang.String V1, java.lang.String V2, org.apache.bcel.generic.Type V3, org.apache.bcel.generic.Type[] V4, short V5) throws Exception {
        ...
        candidateObjects.put("{ROOT}:name", V2);
        candidateObjects.put("{ROOT}:ret_type", V3);
        candidateObjects.put("{ROOT}:arg_types", V4);
        candidateObjects.put("{ROOT}:kind", V5);
