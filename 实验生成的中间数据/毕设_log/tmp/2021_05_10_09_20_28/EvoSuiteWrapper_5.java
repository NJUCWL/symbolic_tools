...
public class EvoSuiteWrapper_5 {
    ...
    public EvoSuiteWrapper_5(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.InstructionFactory V0, java.lang.String V1, java.lang.String V2, org.apache.bcel.generic.Type V3, short V4) throws Exception {
        ...
        candidateObjects.put("{ROOT}:type", V3);
        candidateObjects.put("{ROOT}:kind", V4);
