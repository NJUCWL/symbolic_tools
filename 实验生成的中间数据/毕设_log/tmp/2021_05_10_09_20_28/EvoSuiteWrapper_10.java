...
public class EvoSuiteWrapper_10 {
    ...
    public double test0(short V0, org.apache.bcel.generic.InstructionHandle V1) throws Exception {
        ...
        candidateObjects.put("{ROOT}:opcode", V0);
        candidateObjects.put("{ROOT}:target", V1);
