...
public class EvoSuiteWrapper_23 {
    ...
    public EvoSuiteWrapper_23(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.MethodGen V0, java.lang.String V1, org.apache.bcel.generic.Type V2, int V3, org.apache.bcel.generic.InstructionHandle V4, org.apache.bcel.generic.InstructionHandle V5) throws Exception {
        ...
        candidateObjects.put("{ROOT}:type", V2);
        candidateObjects.put("{ROOT}:slot", V3);
        candidateObjects.put("{ROOT}:start", V4);
        candidateObjects.put("{ROOT}:end", V5);
