...
public class EvoSuiteWrapper_54 {
    ...
    public EvoSuiteWrapper_54(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.MethodGen V0, org.apache.bcel.generic.LocalVariableGen V1) throws Exception {
        ...
        candidateObjects.put("{ROOT}:l", V1);
