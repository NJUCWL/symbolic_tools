...
public class EvoSuiteWrapper_55 {
    ...
    public EvoSuiteWrapper_55(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.ConstantPoolGen V0, org.apache.bcel.generic.InstructionList V1, org.apache.bcel.generic.CodeExceptionGen[] V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:cp", V0);
        candidateObjects.put("{ROOT}:il", V1);
        candidateObjects.put("{ROOT}:et", V2);
