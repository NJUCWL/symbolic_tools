...
public class EvoSuiteWrapper_4 {
    ...
    public EvoSuiteWrapper_4(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.MethodGen V0, org.apache.bcel.generic.InstructionHandle V1, org.apache.bcel.generic.InstructionHandle V2, org.apache.bcel.generic.InstructionHandle V3, org.apache.bcel.generic.ObjectType V4) throws Exception {
        ...
        candidateObjects.put("{ROOT}:start_pc", V1);
        candidateObjects.put("{ROOT}:end_pc", V2);
        candidateObjects.put("{ROOT}:handler_pc", V3);
        candidateObjects.put("{ROOT}:catch_type", V4);
