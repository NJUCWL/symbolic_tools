...
public class EvoSuiteWrapper_26 {
    ...
    public EvoSuiteWrapper_26(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.MethodGen V0, org.apache.bcel.generic.InstructionHandle V1, int V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:src_line", V2);
