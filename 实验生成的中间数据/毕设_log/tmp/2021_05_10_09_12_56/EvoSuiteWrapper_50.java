...
public class EvoSuiteWrapper_50 {
    ...
    public EvoSuiteWrapper_50(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.MethodGen V0, int V1, org.apache.bcel.generic.AnnotationEntryGen V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:parameterIndex", V1);
        candidateObjects.put("{ROOT}:annotation", V2);
