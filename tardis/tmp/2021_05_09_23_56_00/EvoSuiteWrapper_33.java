...
public class EvoSuiteWrapper_33 {
    ...
    public EvoSuiteWrapper_33(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.ConstantPoolGen V0, java.lang.String V1) throws Exception {
        ...
        candidateObjects.put("{ROOT}:str", V1);
