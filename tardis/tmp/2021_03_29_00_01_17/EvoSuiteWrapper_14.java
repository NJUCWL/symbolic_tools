...
public class EvoSuiteWrapper_14 {
    ...
    public EvoSuiteWrapper_14(ClassLoader classLoader) {
        this.classLoader = classLoader;
    }

    public double test0(org.apache.bcel.generic.ConstantPoolGen V0, org.apache.bcel.classfile.Constant V1, org.apache.bcel.generic.ConstantPoolGen V2) throws Exception {
        ...
        candidateObjects.put("{ROOT}:c", V1);
        candidateObjects.put("{ROOT}:cp", V2);
